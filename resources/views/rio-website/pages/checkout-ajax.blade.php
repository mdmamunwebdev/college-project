                                                ...
                                                <div class="products">
                                                    @foreach( $items as $item )
                                                        @if( $category->id === $item->category_id )
                                                            <div class="product">
                                                                <img src="{{ asset($item->product->image) }}" alt="" class="img-thumbnail p-1 h-50 w-75"/>
                                                                <div>
                ...
                <div class="col-md-7 col-lg-8">
                    ...
                    <form class="needs-validation" novalidate action="{{ route('order.place') }}"  method="post">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <label for="cus_address2" class="form-label">Address 2 <span class="text-body-secondary">(Optional)</span></label>
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="same-address" name="same_address" value="sameAddr" onclick="shippingAddress()"  data-bs-toggle="collapse" data-bs-target="#collapseShipping" aria-expanded="false" aria-controls="collapseShipping"/>
                        ...
                        <div class="collapse show mt-3" id="collapseShipping">
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="ship_firstName" name="ship_firstName" placeholder=""  />
                                    <div class="invalid-feedback">
                                        Valid first name is required.
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="ship_lastName" name="ship_lastName" placeholder="" />
                                    <div class="invalid-feedback">
                                        Valid last name is required.
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <label for="ship_address2" class="form-label">Address 2 <span class="text-body-secondary">(Optional)</span></label>
                        ...
                        <div class="my-3">
                            <div class="form-check ">
                                <input id="bkash"  name="paymentMethod" value="0" type="radio" class="form-check-input"  required>
                                <label class="form-check-label" for="bkash">Bkash</label>
                            </div>
                            <div class="form-check ">
                                <input id="rocket"  name="paymentMethod" value="1" type="radio" class="form-check-input" required>
                                <label class="form-check-label" for="rocket">Rocket</label>
                            </div>
                            <div class="form-check ">
                                <input id="nagad"  name="paymentMethod" value="2" type="radio" class="form-check-input" required>
                                <label class="form-check-label" for="nagad">Nagad</label>
                            </div>
                            <div class="form-check">
                                <input id="cashOn"  name="paymentMethod" value="3" type="radio" class="form-check-input" checked required>
