        ...
        <div class="row g-3">
            <div class="col-md-4">
                <form action="{{ route('category.create') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card card-body neumo-primary mb-2 mt-3 p-0 border-secondary-neumo">
                        <button type="submit" class="btn btn-sm rounded-0 w-100 p-1 text-secondary-neumo">Add Category</button>
                    </div>
            ...
            <div class="col-md-8">
                <div class="card card-body neumo-primary p-2">
                    <table id="example" class="table table-hover table-striped text-capitalize text-primary-size text-neumo" style="width:100%">
                        <thead>
                        <tr>
                            <th>SL/NO</th>
                            <th>Name</th>
                        ...
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td>
                                    <div>
                                        @if($category->image)
                                            <img class="img-thumbnail h-25 w-25" src="{{ asset( $category->image ) }}" alt=""/>
                                        @else
                                            <img class="img-thumbnail h-25 w-25" src="https://cdn.icon-icons.com/icons2/1378/PNG/512/avatardefault_92824.png" alt=""/>
                                        @endif
                                    </div>
                                </td>
                                <td><span class="badge  {{ $category->status == 1 ? 'bg-success':'bg-danger' }}">{{ $category->status == 1 ? 'Active':'Deactive' }}</span></td>
                                <td>
                                    <ul class="list-unstyled hstack gap-1 mb-0">
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                                            <button class="btn btn-sm btn-soft-primary" data-bs-toggle="modal" data-bs-target=".category-detailModal-{{ $category->id }}"><i class="bi bi-eye"></i></button>
                                        </li>
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="Status">
                                            <a href="#" class="btn btn-sm btn-soft-secondary"><i class="bi bi-arrow-up-circle"></i></a>
                                        </li>
                                        <li data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                            <a href="#" class="btn btn-sm btn-soft-info"><i class="bi bi-pencil-square"></i></a>
                                        </li>
                                    </ul>

                                    <!-- Category Details Modal -->
                                    <div class="modal fade Category-detailModal-{{ $category->id }}" tabindex="-1" role="dialog" aria-labelledby="Category-detailModalLabel-{{ $category->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable" role="document" style="max-width: 900px">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="Category-detailModalLabel-{{ $category->id }}">Category Details</h5>
                                                                ...
                                                                <div class="row g-2">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="card bg-light">
                                                                            @if($category->image)
                                                                                <img src="{{ asset( $category->image ) }}" alt="" class="card-img-top"/>
                                                                            @else
                                                                                <img src="https://cdn.icon-icons.com/icons2/1378/PNG/512/avatardefault_92824.png" alt="" class="card-img-top"/>
                                                                            @endif
                                                                            <div class="card-header text-center text-capitalize">{{ $category->name }}</div>
                                                                            <div class="card-body">
