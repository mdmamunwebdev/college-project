                ...
                <div class="col-md-4">
                    <div class="card card-body accordion neumo-primary" id="accordionPublish" style="font-size: 12px">
                                ...
                                <div class="accordion-body bg-neumo">
                                    <div class="card-header px-0 bg-neumo">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <button type="submit" id="productStatusBtn"  class="btn btn-sm neumo-primary border-secondary-neumo text-secondary-neumo text-primary-size d-none">Save Draft</button>
                                            </div>
                                            <div>
                                                <div id="productPreview" class="btn  btn-sm neumo-primary border-secondary-neumo text-secondary-neumo text-primary-size">Preview</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between my-2 text-neumo">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu neumo-primary">
                                                <li><a class="dropdown-item" href="#" onclick="productStatus(0)">Published</a></li>
                                                <li><a class="dropdown-item" href="#" onclick="productStatus(1)">Pending Review</a></li>
                                                <li><a class="dropdown-item" href="#" onclick="productStatus(2)">Draft</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between mb-2 text-neumo">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu neumo-primary">
                                                <li><a class="dropdown-item" href="#" onclick="productVisibility(0)">Public</a></li>
                                                <li><a class="dropdown-item" href="#" onclick="productVisibility(1)">Private</a></li>
                                                <li><a class="dropdown-item" href="#" onclick="productVisibility(2)">Only for users</a></li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-between mb-2 text-neumo">
                                        ...
                                        <div class="neumo-primary px-2 border-dark-neumo" style="width: 42%">
                                            <input type="text" name="published_date" id="publishedDate" class="p-1 border-0 text-center w-100 h-100 bg-neumo"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-footer bg-neumo">
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    <button type="submit" id="productPublished" class="btn btn-sm neumo-primary text-secondary-neumo border-secondary-neumo text-primary-size">Published</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card neumo-primary">
                        <div class="d-flex  justify-content-between border-bottom border-1 border-light ">
                            ...
                            <div class="btn btn-sm text-secondary-neumo"  data-bs-toggle="collapse" data-bs-target="#collapseImage" aria-expanded="false" aria-controls="collapseImage">
...
{{--                                <input id="prdoductImage" type="file"  name="image"/>--}}
                                ...
                                <div class="upload">
                                    <img id="image" class="h-100 w-100" src="https://thumbs.dreamstime.com/b/shopping-cart-icon-vector-male-person-outline-symbol-flat-color-glyph-pictogram-illustration-211929604.jpg" alt="">
