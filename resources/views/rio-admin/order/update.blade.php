                                                        ...
                                                        <div class="card bg-neumo neumo-primary my-2">
                                                            <div class="card-body p-3">
                                                                ...
                                                                <form id="shipping_fees">
                                                                    <div class="d-flex justify-content-between align-items-center">
                                                                        <input type="number" name="coupon" placeholder="Apply your Shipping Fees here"  class="form-control w-75" style="font-size: 11px; padding: 8px;"/>
                                                                        <button class="btn ms-2 bg-neumo neumo-primary flex-grow-1">Apply</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                            ...
                                                            <div class="row g-2">
                                                                <div class="col-4">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-12">
                                                                            <select class="form-select neumo-primary border-neumo text-primary-size"  name="category_id" id="productCat">
                                                                ...
                                                                <div class="col-2">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-12">
                                                                            <input type="number" min="1" name="product_qty" id="custom_product_qty" class="form-control" style="font-size: 11px; padding: 8px;" value="1" onkeyup="valueCheck(this)"/>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-2">
                                                        ...
                                                        <div id="orderedProduct">
                                                            @foreach($orderedProduct as $orderedProductItem)
                                                                ...
                                                                <div class="d-flex justify-content-between border align-items-center border-success my-2  py-1 px-3 neumo-primary border-secondary-neumo">
                                                                    ...
                                                                    <input type="number" min="1" name="product_qty" class="form-control" id="product_qty_{{ $orderedProductItem->id }}" style="font-size: 11px; padding: 8px; width: 20%" value="{{ $orderedProductItem->product_qty }}" onkeyup="productQty({{ $orderedProductItem->id }})"/>
                                                                    <span>{{ $orderedProductItem->sale_price }}</span>
                                                                    <span class="text-danger" style="cursor: pointer;" id="orderedProductDel" onclick="orderedProductDel( {{$orderedProductItem->id}} )">&cross;</span>
                                                                </div>
                                            ...
                                            <div class="accordion-body bg-neumo">
                                                <div class="d-flex justify-content-between mb-2 text-neumo">
                                                    ...
                                                    <div class="neumo-primary  border-dark-neumo" style="width: 50%">
                                                        <input readonly type="text"  id="" class="p-1 border-0 text-center w-100 h-100 bg-neumo" value="{{ $order->order_create_date }}"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
